...
export default function WindowScreen() {
  return (
    <div className="flex items-center justify-center h-screen w-full bg-[radial-gradient(circle,_theme(colors.neutral.100)_1px,_transparent_1px)] [background-size:10px_10px] ">
