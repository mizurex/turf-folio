    ...
    <main className="relative min-h-dvh flex flex-col items-center justify-center bg-background">
      ...
      <div className="max-w-3xl w-full px-6">
        <section className="py-2">
          ...
          <div className="relative flex items-start justify-between gap-3 pt-4">
            ...
            <div className="flex items-start border-b border-border"> 
               <h3 className="font-mono text-2xl font-light underline mb-3">About Me</h3>
            </div>
             
              <h2 className="font-mono text-lg mt-4 border-b border-border w-fit">Jay (@PotatoTurf)</h2>
        ...
        <section className="mt-8">
          <div className="flex items-start border-b border-border">
              <h2 className="text-2xl font-mono font-light mb-3 underline">Projects</h2>
          </div>
          <div>
            <h3 className="font-mono text-lg mb-3 pt-6 ">All Projects <strong className="text-muted-foreground">{'>'}</strong></h3>
        ...
        <section className="mt-10">
          ...
          <div className="flex items-start border-b border-border w-full">
              <h2 className="text-2xl font-mono font-light mb-3 underline">Contributions</h2>
          </div>

          <div>
            <h3 className="font-mono text-lg mb-3 pt-6 ">All Contributions </h3>
        ...
        <section className="mt-10">
        <div className="flex items-start border-b border-border w-full">
              <h2 className="text-2xl font-mono font-light mb-3 underline">Stack</h2>
          </div>
        ...
        <section className="py-20">
          <div className="flex justify-center items-center border-b border-border relative">
            ...
            <h4 className="font-mono text-lg mb-3 pt-6 "> Thanks a lot for checking out my work! </h4>
          </div>
        </section>
      </div>
